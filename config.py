...
API_ID = int(os.environ.get("API_ID", "21572824"))
API_HASH = os.environ.get("API_HASH", "cc88cfb3d1cc2d0c9baea879e0fc62b0")
...
try:
    ADMINS=[6848088376]
    for x in (os.environ.get("ADMINS", "1685470205").split()):
        ADMINS.append(int(x))
except ValueError:
